...
describe('usage', () => {
  ...
  it('calculates annual energy usage given monthly spend and plan that has a whole bill discount', () => {
    expect(usage('southern-electric', '1 Year Fixed Price', 756.89, plans)).toEqual(5000);
  });
});
